...
const uint8_t Node1Addr[6] = "00002";
const uint8_t  Node2Addr[6] = "00003";

float ax,ay,az,gx,gy,gz,node1_diff,node2_diff;
...
recieve_data recievePacket(const uint8_t pipe_number);
void setupSensor()
{
...
void loop() 
{
  ...
  send_packet.gy = gy;
  send_packet.gz = gz;
  send_packet.node1_diff = node1_diff;
  send_packet.node2_diff = node2_diff;
  ...
  node1_diff = packet1.diff;
  node2_diff = packet2.diff;
