...
#define leftFootBackward -20;
#define leftFootForward -20;
#define rightFootBackward -20;
#define rightFootForward -20;
...
void detectImbalance()
{
    ...
    /******************************First Step Definition*************************************/ 
      if (nodeA_diff > leftFootForward && nodeB_diff < rightFootBackward){
        firstStep = true;
      }
      else if (nodeA_diff < leftFootBackward && nodeB_diff > rightFootForward){
        firstStep = true;
      }
      else{
        firstStep = false;
